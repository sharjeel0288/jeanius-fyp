...
const Results = ({ imgSelected, measurementsData }) => {
  ...
  return (
    <Box>
      <Flex bg={useBgColor} p={4} borderRadius="lg" justify="center">
        <Image
          src={`data:image/png;base64,${measurementsData[0].image}`}
          loading="lazy"
          boxSize="360px"
        />
      </Flex>
      {imgSelected ? (
        <Box>
          ...
          <Flex gap={4} wrap="wrap" justify="space-evenly">
            {measurementsData[0]?.measurements?.map((measurement, index) => (
              ...
              >
                ...
                {measurement?.measurements?.class_name &&
                  measurement?.measurements?.class_name.includes("button") && (
                    <Flex direction="column">
                      <Flex justify="space-between">
                        <Text color={useTextColor}>Pixel To CM factor:</Text>
                        <Text fontWeight="semibold">
                          {measurement?.measurements?.pixel_to_cm_factor}
                        </Text>
                      </Flex>
                      <Flex justify="space-between">
                        <Text color={useTextColor}>Radius (cm):</Text>
                        <Text fontWeight="semibold">
                          {measurement?.measurements?.radius_cm}
                        </Text>
                      </Flex>
                      <Flex justify="space-between">
                        <Text color={useTextColor}>Diameter (cm):</Text>
                        <Text fontWeight="semibold">
                          {measurement?.measurements?.diameter_cm}
                        </Text>
                      </Flex>
                      <Flex justify="space-between">
                        <Text color={useTextColor}>Circumference (cm):</Text>
                        <Text fontWeight="semibold">
                          {measurement?.measurements?.circumference_cm}
                        </Text>
                      </Flex>
                    </Flex>
                  )}
                {!(
                  ...
                  <Flex direction="column">
                    ...
                    <Flex justify="space-between">
                      ...
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.top_to_bottom_height}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                      <Text color={useTextColor}>Left Width:</Text>
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.left_width}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                      <Text color={useTextColor}>Right Width:</Text>
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.right_width}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                      <Text color={useTextColor}>Top Distance:</Text>
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.max_distances?.top_distance}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                      ...
                      <Text fontWeight="semibold">
                        {
                          measurement?.measurements?.max_distances
                            ?.bottom_distance
                        }
                      </Text>
                    </Flex>
                    ...
                    <Flex justify="space-between">
                      ...
                      <Text fontWeight="semibold">
                        {
                          measurement?.measurements?.length_distances
                            ?.right_length
                        }
                      </Text>
                    </Flex>
                    ...
                    <Flex justify="space-between">
                      ...
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.right_diagonal_distance}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                      <Text color={useTextColor}>Left Diagonal Distance:</Text>
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.left_diagonal_distance}
                      </Text>
                    </Flex>
                    <Flex justify="space-between">
                    ...
                    <Flex justify="space-between">
                      ...
                      <Text fontWeight="semibold">
                        {measurement?.measurements?.perimeter}
                      </Text>
                    </Flex>
                  </Flex>
                )}
